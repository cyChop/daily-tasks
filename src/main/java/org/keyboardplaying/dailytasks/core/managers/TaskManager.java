...
public class TaskManager {
    ...
    public Task updateTask(int taskId, boolean done) {
        ...
        try {
            ...
            Logger.getLogger(getClass().getName()).log(Level.WARNING,
                    String.format("Update task #%d (to done = %b) could not be performed.", taskId, done), e);
        }
    ...
    /**
     * Creates a default {@link TaskSet} containing only one {@link Task} proposing to create more.
     *
