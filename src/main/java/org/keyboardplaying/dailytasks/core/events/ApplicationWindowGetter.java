...
public class ApplicationWindowGetter implements WindowGetter {
    ...
    public JFrame getMainWindow() {
        ...
        JFrame window = WindowFactory.makeMainWindow(getUIPrefs().isAlwaysOnTop(), this, tasks, taskStateListener);
     ...
     * (non-Javadoc)
     *
     * @see org.keyboardplaying.dailytasks.ui.WindowGetter#getPreferencesWindow()
     */
    @Override
    public JFrame getPreferencesWindow() {
        UIPreferences prefs = getUIPrefs();
        return WindowFactory.makePreferencesWindow(prefs.isAlwaysOnTop(), prefs, new UIPreferencesSaver(), controller);
    }
