 ...
 * <p/>
 * This class is the main controller for the windows. It is not logic-rich
 * though.
 * 
...
public class Application implements ApplicationController {
	 ...
	 * 
	 * @see
	 * org.keyboardplaying.dailytasks.ui.events.ApplicationController#restart()
	 */
	@Override
	public void restart() {
		disposeAllWindows();
	 ...
	 * 
	 * @see
	 * org.keyboardplaying.dailytasks.ui.events.ApplicationController#terminate
	 * ()
	 */
	@Override
	...
	/**
	 * Disposes all windows to release memory so that they can be launched anew
	 * if need be.
	 */
