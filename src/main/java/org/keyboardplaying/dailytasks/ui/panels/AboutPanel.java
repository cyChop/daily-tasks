...
public class AboutPanel extends JPanel {
    ...
    public AboutPanel() {
        ...
        setBorder(BorderFactory.createEmptyBorder(WINDOW_MARGIN, WINDOW_MARGIN, WINDOW_MARGIN, WINDOW_MARGIN));
    ...
    private void buildTextContent() {
        ...
        appNameAndVersion.setFont(appNameAndVersion.getFont().deriveFont(Font.BOLD));
