...
public class PreferencesPanel extends JPanel {
    ...
    /**
     * The standard gap for separating semantically different buttons in the layout.
     */
    ...
    private void initSettingComponents(UIPreferences preferences) {
        ...
        localeCB.setSelectedItem(MessageBundle.getClosestApplicableLocale(preferences.getLocale()));
    ...
    private class SaveButtonListener implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            UIPreferences newPrefs = new UIPreferences((Locale) localeCB.getSelectedItem(),
                    (Theme) themeCB.getSelectedItem(), onTopCheckBox.isSelected());
            listener.saveUIPreferences(newPrefs);

            // propose auto-restart
            int exit = JOptionPane.showConfirmDialog(PreferencesPanel.this,
                    MessageBundle.get("confirm.restart.to.apply.prefs"), MessageBundle.get("confirm.restart.title"),
            ...
            if (exit == JOptionPane.YES_OPTION) {
                ...
                WindowUtils.triggerClosingEvent((Window) PreferencesPanel.this.getTopLevelAncestor());
            }
        }
    }
