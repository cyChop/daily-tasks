...
public final class WindowFactory {
    ...
    public static JFrame makeMainWindow(boolean alwaysOnTop, WindowGetter getter, TaskSet tasks,
        ...
        if (window == null) {
            ...
            window = new ApplicationWindow("app.title", NAME_MAIN, panel, alwaysOnTop);
        }
        return window;
    }
    ...
    public static JFrame makePreferencesWindow(boolean alwaysOnTop, UIPreferences prefs,
        ...
        if (window == null) {
            window = new ApplicationWindow("app.settings", NAME_PREFS,
                    new PreferencesPanel(prefs, listener, controller), alwaysOnTop);
        }
        return window;
    }
    ...
    public static JFrame makeAboutWindow(boolean alwaysOnTop) {
        ...
        if (window == null) {
            window = new ApplicationWindow("app.about", NAME_ABOUT, new AboutPanel(), alwaysOnTop);
        }
        return window;
    }
}
