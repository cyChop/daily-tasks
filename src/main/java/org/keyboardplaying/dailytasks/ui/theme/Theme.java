 ...
 * </ul>
 *
 * @author cyChop (https://keyboardplaying.org)
 */
public enum Theme {
     ...
     *
     * @param bgColor  the background color for this theme
     * @param txtColor the task font color for this theme
     */
    Theme(Color bgColor, Color txtColor) {
     ...
     * @param bgColor  the background color for this theme
     * @param txtColor the task font color for this theme
     * @param icon     the icon which matches this theme
     */
    Theme(Color bgColor, Color txtColor, String icon) {
